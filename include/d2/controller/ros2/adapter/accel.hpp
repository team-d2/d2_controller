#ifndef D2__CONTROLLER__ROS2__ADAPTOR__ACCEL_HPP_
#define D2__CONTROLLER__ROS2__ADAPTOR__ACCEL_HPP_
...
using Accel = rclcpp::TypeAdapter<Eigen::Vector<double, 6>, geometry_msgs::msg::Accel>;
